  ...
  return {
    SynchronizeContactPerson(query) {
      return doCall({
        ...
        service,
        query,
        operation: "SynchronizeContactPerson",
      });
    },
    SynchronizePrivatePerson(query) {
      return doCall({
        ...
        service,
        query,
        operation: "SynchronizePrivatePerson",
      });
    },
    SynchronizeEnterprise(query) {
      return doCall({
        ...
        service,
        query,
        operation: "SynchronizeEnterprise",
      });
    },
    ...
    UpdatePrivatePerson(query) {
      return doCall({
        ...
        service,
        query,
        operation: "UpdatePrivatePerson",
      });
    },
    UpdateContactPerson(query) {
      return doCall({
        ...options,
        service,
        query,
